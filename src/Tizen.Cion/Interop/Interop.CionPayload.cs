...
internal static partial class Interop
{
    internal static partial class CionPayload
    {
        ...
        [DllImport(Libraries.Cion, EntryPoint = "cion_payload_destory")]
        ...
        internal static extern ErrorCode CionPayloadGetData(PayloadSafeHandle payload, out byte[] data, out int dataSize);
        ...
        internal static extern ErrorCode CionPayloadGetReceivedBytes(PayloadSafeHandle payload, out long bytes);

        [DllImport(Libraries.Cion, EntryPoint = "cion_payload_get_total_bytes")]
        internal static extern ErrorCode CionPayloadGetTotalBytes(PayloadSafeHandle payload, out long bytes);
